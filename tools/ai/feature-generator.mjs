...
class AIFeatureGenerator {
  ...
  async generateDomainLayer() {
    console.log('🏗️ Generating domain layer...');

    // Domain Entity
    const entityContent = this.generateEntityTemplate();
  ...
  async generateApplicationLayer() {
    ...
    // DTOs
    const dtoContent = this.generateDtoTemplate();
  ...
  async generateInfrastructureLayer() {
  ...
  async generatePresentationLayer() {
    ...
    const layoutContent = this.generateLayoutTemplate();
  ...
  async updateConfiguration() {
    ...
    // Update types index if it exists
...
export interface ${useCaseName}Response {
  ...
  generateUseCaseImplementation(operation) {
    switch (operation) {
      case 'get':
...
if (require.main === module) {
  ...
  const generator = new AIFeatureGenerator();
