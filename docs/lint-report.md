...
111. (hard) [E] token-rules/no-raw-color-classes — app/shared/components/responsive-image/ResponsiveImage.Extras.stories.tsx:53:22 — Avoid using raw color utility "bg-gray-900". Use design tokens instead. — FIXED
