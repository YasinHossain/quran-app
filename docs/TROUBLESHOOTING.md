...
**Problem**: Safari shows "cannot connect to the server" when opening the app during local development.
...
- Hard refresh: hold Option and click Reload, or clear website data for `localhost`.
