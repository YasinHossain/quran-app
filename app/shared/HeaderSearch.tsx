  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        onKeyDown={onKeyDown}
        className={`w-full pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-accent transition-all duration-300 hover:shadow-lg hover:ring-1 hover:ring-accent-hover ${searchBarClasses}`}
      />
    </div>
  );
};
