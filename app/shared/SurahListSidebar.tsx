...
const SurahListSidebar = ({ initialChapters = [] }: Props) => {
  ...
  return (
    <>
      ...
      <aside
        className={`drawer-panel pt-safe pb-safe md:pt-0 md:pb-0 md:static top-16 md:top-0 bottom-0 left-0 w-full sm:w-80 lg:w-[20.7rem] bg-background text-foreground flex flex-col shadow-modal md:shadow-lg z-modal md:z-10 md:h-full ${
