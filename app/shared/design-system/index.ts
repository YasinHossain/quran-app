...
export const componentClasses = {
  ...
  // Button variants
  button: {
    primary: 'bg-accent text-white px-4 py-2 rounded-lg font-medium hover:bg-accent-hover transition-colors focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2',
    secondary: 'bg-gray-100 dark:bg-gray-800 text-foreground px-4 py-2 rounded-lg font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors',
