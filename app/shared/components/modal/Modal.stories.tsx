...
/**
 * Modal component stories demonstrating modal functionality
 * with different content types and responsive behavior
 */
...
export const Mobile: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Modal behavior on mobile devices with proper responsive adjustments.',
      },
    },
  },
};
...
export const DarkTheme: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Modal appearance in dark theme mode.',
      },
    },
  },
  decorators: [
