 ...
 */
function buildSurahDescription(chapter: Chapter | undefined, rawId: string, surahId: number): string {
  if (!chapter) {
 ...
 */
function buildSurahJsonLd(chapter: Chapter | undefined, rawId: string, surahId: number) {
