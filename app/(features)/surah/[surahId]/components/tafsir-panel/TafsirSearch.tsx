...
export const TafsirSearch: React.FC<TafsirSearchProps> = ({ searchTerm, setSearchTerm }) => (
  <div className="relative">
    ...
    <input
      ...
      className="w-full pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition border bg-interactive border-border text-primary"
    />
  </div>
);
