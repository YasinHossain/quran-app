...
export const SimpleSectionHeader = ({ 
  ...
  const getVariantClasses = () => {
    switch (variant) {
      case 'pinned':
        return {
          badge: 'bg-amber-100 dark:bg-amber-900/30 text-amber-800 dark:text-amber-200 border-amber-200 dark:border-amber-800',
        };
      case 'lastRead':
        return {
          badge: 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-800 dark:text-indigo-200 border-indigo-200 dark:border-indigo-800',
        };
      default: // folder
        return {
          badge: 'bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-200 border-teal-200 dark:border-teal-800',
        };
    }
  };
