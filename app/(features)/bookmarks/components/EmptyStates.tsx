...
const BookmarkIllustration = (): React.JSX.Element => (
...
const EmptyBookmarksContent = (): React.JSX.Element => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
...
const PrimaryAction = ({ onCreateFolder }: PrimaryActionProps): React.JSX.Element => (
  <motion.div
...
const QuickStartGuide = (): React.JSX.Element => (
  <motion.div
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
...
const SearchContent = ({ searchTerm }: SearchContentProps): React.JSX.Element => (
  <motion.div
...
const SearchActions = ({ onClearSearch }: SearchActionsProps): React.JSX.Element => (
  <motion.div
    initial={{ opacity: 0, scale: 0.9 }}
    animate={{ opacity: 1, scale: 1 }}
