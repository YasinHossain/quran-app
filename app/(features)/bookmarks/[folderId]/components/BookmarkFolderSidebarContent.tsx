...
export const BookmarkFolderSidebarContent = ({
  ...
  <div className="relative flex flex-1 min-h-0 flex-col">
    <SidebarHeader
      ...
      className="sticky top-0 shadow-none relative z-10 bg-background md:hidden"
      forceVisible
    />

    {/* Desktop Header: Hidden on mobile, Flex on md+ */}
    <div className="hidden md:flex items-center justify-between px-4 pb-4 pt-2 shrink-0">
      <button
        type="button"
        onClick={onBack}
