              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="w-full flex justify-between items-center bg-[var(--background)] border border-gray-300 dark:border-gray-600 rounded-full p-2.5 text-sm text-left hover:border-teal-500 transition"
                  >
