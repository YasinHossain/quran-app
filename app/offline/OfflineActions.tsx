  ...
  return (
    <div className="w-full space-y-4">
      ...
      <button
        type="button"
        onClick={goBack}
        className="w-full rounded-lg border border-border bg-surface px-6 py-3 font-medium text-foreground transition-colors hover:bg-gray-200 dark:hover:bg-slate-700"
      >
        Go Back
      </button>
    </div>
