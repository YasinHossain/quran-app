export default function HomePageBackground() {
  return (
    <div className="absolute top-0 left-0 -z-10 h-full w-full bg-white bg-gradient-to-br from-cyan-50/20 via-white to-emerald-50/20 dark:bg-gray-900 dark:from-gray-900 dark:to-slate-900">
      {/* Decorative Blobs */}
