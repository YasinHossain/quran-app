...
export const INLINE_UI_LANGUAGE_SCRIPT = `(function(){try{var k='ui-language';var s=['en','bn','ar','ur','hi'];var l=null;try{var p=location&&location.pathname?location.pathname.split('/')[1]:null;if(p&&s.indexOf(p)>-1)l=p}catch(e){}if(!l){try{var re=new RegExp('(?:^|; )'+k+'=([^;]+)');var m=document.cookie.match(re);var c=m?decodeURIComponent(m[1]):null;if(c&&s.indexOf(c)>-1)l=c}catch(e){}}if(!l){try{var v=localStorage.getItem(k);if(v&&s.indexOf(v)>-1)l=v}catch(e){}}if(!l)return;var r=document.documentElement;if(r){if(r.lang!==l)r.lang=l;try{r.dir=(l==='ar'||l==='ur')?'rtl':'ltr'}catch(e){}}try{var c2=k+'='+encodeURIComponent(l)+'; path=/; max-age=31536000; SameSite=Lax';try{if(location&&location.protocol==='https:')c2+='; Secure'}catch(e){}document.cookie=c2}catch(e){}try{localStorage.setItem(k,l)}catch(e){}}catch(e){}})()`;
