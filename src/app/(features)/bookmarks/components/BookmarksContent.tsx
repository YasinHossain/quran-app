...
import { BookmarkIcon, PinIcon, ClockIcon, BrainIcon } from '@/presentation/shared/icons';
import {
  BookmarkNavigationCard,
  BookmarkFolderCard,
  BookmarkVerseCard,
} from '@/presentation/shared/ui/cards';
import type {
  BookmarkNavigationContent,
  SectionId,
} from '@/presentation/shared/ui/cards/BookmarkNavigationCard';
import type { Folder } from '@/domain/entities/bookmark';
